...
//        IFC.infiniteFlight.serverAddress = data.Addresses[0];
    ...
    IFC.infiniteFlight.discoverSocket.on('error', function(e){
      IFC.log(e, MANDATORY);
      IFC.eventEmitter.emit('IFCCommandError',e); // Return data to calling script through an event
    });

    IFC.infiniteFlight.discoverSocket.on('close', function(){
      IFC.log("DGRAM closed", MANDATORY);
      IFC.eventEmitter.emit('IFCCommandError',"DGRAM closed"); // Return data to calling script through an event
    });
  ...
  initIFClient: function(host, port) { // Initiaise the module
    ...
    if (IFC.infiniteFlight.clientSocket) IFC.infiniteFlight.clientSocket.end();
    ...
    IFC.infiniteFlight.clientSocket.on('close', function(e) {
    	IFC.infiniteFlight.clientSocket = false;
      IFC.eventEmitter.emit('IFCCommandError',{"type": "info", code: "close", context: "client", "msg": "Polling socket connection to Infinite Flight closed"}); // Return data to calling script through an event
    });

    IFC.infiniteFlight.clientSocket.on('drain', function(e) {
      IFC.log(e, MANDATORY);
      IFC.eventEmitter.emit('IFCCommandError',{"type": "info", code: "drain", context: "client", "msg": "Polling socket connection to Infinite Flight drained"}); // Return data to calling script through an event
    });

    IFC.infiniteFlight.clientSocket.on('lookup', function(e) {
      IFC.log(e, MANDATORY);
    });

    IFC.infiniteFlight.clientSocket.on('end', function(e) {
      IFC.log(e, MANDATORY);
      IFC.eventEmitter.emit('IFCCommandError',{"type": "info", code: "end", context: "client", "msg": "Polling socket connection to Infinite Flight ended"}); // Return data to calling script through an event
    });

    IFC.infiniteFlight.clientSocket.on('timeout', function(e) {
      IFC.log(e, MANDATORY);
      IFC.eventEmitter.emit('IFCCommandError',{"type": "error", code: "timeout", context: "client", "msg": "Timeout on polling socket connection to Infinite Flight"}); // Return data to calling script through an event
    });

    IFC.infiniteFlight.clientSocket.on('error', function(e) {
      IFC.log(e, MANDATORY);
      IFC.eventEmitter.emit('IFCCommandError',{"type": "error", code: "error", context: "client", "msg": "Error polling Infinite Flight"}); // Return data to calling script through an event
    });
